class DotnetCoreUninstall < Formula
  ...
  on_arm do
    url "https://github.com/dotnet/cli-lab/releases/download/#{version}/dotnet-core-uninstall-osx-arm64.tar.gz"
    sha256 "fa410a8f506f833b3ef211671f1fc4e44a1d6f53473162fdf1e84c91463b6c3e"
  end

  on_intel do
    url "https://github.com/dotnet/cli-lab/releases/download/#{version}/dotnet-core-uninstall-osx-x64.tar.gz"
