...
| -------------------- | -------------------------------|------------------ |
| ⚠️ .NET 11 (Preview) | `11.0.100-rc.1.26425.128` | `dotnet-sdk@11.0` |
| ⭐️ .NET 10 (LTS)     | `10.0.401`                     | `dotnet-sdk@10.0` |
| ⭐️ .NET 9            | `9.0.318`                      | `dotnet-sdk@9.0`  |
| ⭐️ .NET 8 (LTS)      | `8.0.425`                      | `dotnet-sdk@8.0`  |
